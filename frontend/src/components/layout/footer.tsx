    ...
    <footer className="bg-gray-950 py-12 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-semibold text-white mb-2">BioNova</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/crisprPredictor" className="text-gray-400 hover:text-white transition-colors">
                  CRISPR Predictor
                </Link>
              </li>
              <li>
                <Link href="/lab-monitor" className="text-gray-400 hover:text-white transition-colors">
                  Lab Monitor
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-4 text-center text-gray-500 text-sm">
          © {new Date().getFullYear()} BioNova AI. All rights reserved.
        </div>
      </div>
    </footer>
  );
